(function() {
    ...
    RideLog.$inject = ['$rootScope', '$scope', '$http', '$window', '$location', '$state', '$filter', 'urls', 'Auth', 'RideData'];

    function RideLog($rootScope, $scope, $http, $window, $location, $state, $filter, urls, Auth, RideData) {
    ...
    $scope.getData = function () {
     ...
     Auth.getlocations(urls.AVAILABLE_RIDE, function(res) {
            $scope.ride_list = res;
            ...
            swal({
                ...
                function(){
                     Auth.delete_plc(urls.REFUSE_RIDE, id,
                        function(res) {
                            $state.go('main.rideLog', {}, { reload: true });

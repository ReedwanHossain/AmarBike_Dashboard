(function() {
    ...
    angular
        .module('amarbike')
        .controller('RideLogCancelled', RideLogCancelled)
    ...
    RideLogCancelled.$inject = ['$rootScope', '$scope', '$http', '$window', '$location', '$state', '$filter', 'urls', 'Auth'];

    function RideLogCancelled($rootScope, $scope, $http, $window, $location, $state, $filter, urls, Auth) {
    ...
    $scope.getData = function () {
     ...
     Auth.getlocations(urls.CANCELLED_RIDE, function(res) {
            $scope.ride_list = res;

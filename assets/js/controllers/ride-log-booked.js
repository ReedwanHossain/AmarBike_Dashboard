(function() {
    ...
    angular
        .module('amarbike')
        .controller('RideLogBooked', RideLogBooked)
    ...
    RideLogBooked.$inject = ['$rootScope', '$scope', '$http', '$window', '$location', '$state', '$filter', 'urls', 'Auth', 'RideData'];

    function RideLogBooked($rootScope, $scope, $http, $window, $location, $state, $filter, urls, Auth, RideData) {
    ...
    $scope.getData = function () {
     ...
     Auth.getlocations(urls.BOOKED_RIDE, function(res) {
            $scope.ride_list = res;
  ...
  $scope.setPage = function(n) {
    $scope.currentPage = n;
            ...
            swal({
                ...
                function(){
                     Auth.delete_plc(urls.REFUSE_RIDE, id,
                        function(res) {
                            $state.go('main.rideLogBooked', {}, { reload: true });
        ...
        $scope.update_ride = function(ride){
            RideData.set_ride_info(ride);
            $location.path('/ride/update');

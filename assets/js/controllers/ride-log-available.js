(function() {
    ...
    angular
        .module('amarbike')
        .controller('RideLogAvailable', RideLogAvailable)
    ...
    RideLogAvailable.$inject = ['$rootScope', '$scope', '$http', '$window', '$location', '$state', '$filter', 'urls', 'Auth'];

    function RideLogAvailable($rootScope, $scope, $http, $window, $location, $state, $filter, urls, Auth) {
            ...
            swal({
                ...
                function(){
                     Auth.delete_plc(urls.REFUSE_RIDE, id,
                        function(res) {
                            $state.go('main.rideLogAvailable', {}, { reload: true });

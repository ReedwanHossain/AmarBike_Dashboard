(function() {
    ...
    angular
        .module('amarbike')
        .controller('RideOngoing', RideOngoing)
    ...
    RideOngoing.$inject = ['$rootScope', '$scope', '$http', '$window', '$location', '$state', '$filter', 'urls', 'Auth'];

    function RideOngoing($rootScope, $scope, $http, $window, $location, $state, $filter, urls, Auth) {
    ...
    $scope.getData = function () {
     ...
     Auth.getlocations(urls.ONGOING_RIDE, function(res) {
            $scope.ride_list = res;

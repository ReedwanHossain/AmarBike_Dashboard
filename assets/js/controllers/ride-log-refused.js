(function() {
    ...
    angular
        .module('amarbike')
        .controller('RideLogRefused', RideLogRefused)
    ...
    RideLogRefused.$inject = ['$rootScope', '$scope', '$http', '$window', '$location', '$state', '$filter', 'urls', 'Auth'];

    function RideLogRefused($rootScope, $scope, $http, $window, $location, $state, $filter, urls, Auth) {
    ...
    $scope.getData = function () {
     ...
     Auth.getlocations(urls.REFUSED_RIDE, function(res) {
            $scope.ride_list = res;
            ...
            swal({
                ...
                function(){
                     Auth.delete_plc(urls.REFUSE_RIDE, id,
                        function(res) {
                            $state.go('main.rideLogRefused', {}, { reload: true });
